...
start_idx = content.find('function showSatisfactionSurvey() {')
end_idx = content.find('function showEvaluationCards(evals, queryName) {')

new_func = '''function showSatisfactionSurvey() {
...
with open('src/ParentEval.html', 'w', encoding='utf-8') as f:
    f.write(content)
print('Replaced showSatisfactionSurvey successfully')
