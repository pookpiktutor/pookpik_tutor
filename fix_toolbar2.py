...
old_toolbar = '''<div class="toolbar" style="padding: 8px 12px;">
...
new_toolbar = '''<div class="toolbar" style="padding: 8px 12px; display: flex; flex-direction: column; gap: 8px;">
...
if old_toolbar in c:
    ...
    print("[OK] Replaced exact")
else:
    c = c.replace(old_toolbar.replace('\n', '\r\n'), new_toolbar.replace('\n', '\r\n'))
    print("[OK] Replaced with crlf")
