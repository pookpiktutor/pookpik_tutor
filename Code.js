...
function syncStudentToStatusDB(std, batch = false) {
  ...
  if (rowIndex === -1) {
    ...
    if (normalizedClassType.includes('เน€เธ”เธตเนเธขเธง') && !normalizedClassType.includes('เน€เธ”เนเธเน€เธ”เธตเนเธขเธง')) {
        normalizedClassType = 'เน€เธ”เนเธเน€เธ”เธตเนเธขเธง';
    } else if (normalizedClassType.includes('เธขเนเธญเธข')) {
        if (normalizedClassType.includes('2-3')) normalizedClassType = 'เธขเนเธญเธข 2-3';
        else if (normalizedClassType.includes('4-5')) normalizedClassType = 'เธขเนเธญเธข 4-5';
        else if (normalizedClassType.includes('6-10')) normalizedClassType = 'เธขเนเธญเธข 6-10';
        else normalizedClassType = 'เธขเนเธญเธข'; // Fallback
    } else if (normalizedClassType.includes('เธเธฅเธธเนเธกเธซเธฅเธฑเธ') || normalizedClassType === 'Main Class') {
        normalizedClassType = 'เธเธฅเธธเนเธกเธซเธฅเธฑเธ';
    }
    ...
    if (parseFloat(std.paid) > 0) {
      try {
        addPayment({
          ...
          Channel: std.paymentChannel || 'เธเธณเธฃเธฐเนเธฃเธเน€เธเนเธฒ',
          Receiver: std.staff || 'System',
          Round: 'เนเธฃเธเน€เธเนเธฒ',
          Note: std.paymentTimeNote || std.extraNote || 'เธเธฒเธเธเธฒเธฃเธฅเธเธ—เธฐเน€เธเธตเธขเธเธเธฃเธฑเนเธเนเธฃเธ'
        });
      } catch (e) {
...
function syncMissingStudentsToStatusDB() {
  try {
    ...
    for (let i = 0; i < allSheets.length; i++) {
      ...
      const isPrivate = sheetName.indexOf('เน€เธ”เธตเนเธขเธง') === 0 || sheetName.indexOf('เธขเนเธญเธข') === 0 || sheetName.indexOf('เธเธฅเธธเนเธก') === 0 || sheetName.includes('VIP');
      ...
      } else if (!isPrivate && (sheetName.includes('เธ.') || sheetName.includes('เธก.') || sheetName.includes('เธญเธเธธเธเธฒเธฅ'))) {
          isMainClass = true;
      ...
      for (let r = 0; r < scanRange.length; r++) {
         ...
         if (rowVals.includes('เธเธทเนเธญ-เธเธฒเธกเธชเธเธธเธฅ') || rowVals.includes('เธเธทเนเธญ-เธชเธเธธเธฅ') || rowVals.includes('เธเธทเนเธญเธเธฑเธเน€เธฃเธตเธขเธ') || rowVals.includes('เธเธทเนเธญ') || rowVals.includes('เนเธฃเธเน€เธฃเธตเธขเธ') || rowVals.includes('เธเธทเนเธญเนเธเธฃเนเธเธฅเนเนเธฅเธเน')) {
      ...
      const getColIndex = (possibleNames) => {
          ...
          for (let n of possibleNames) {
              const normalizedName = normalizeText(n);
              if (['เธเนเธฒเธข', 'เธเธณเธฃเธฐ', 'เนเธญเธ', 'เธงเธฑเธเธ—เธตเน', 'เน€เธฃเธตเธขเธ'].includes(normalizedName)) continue;
      ...
      // Cache the indices
      const colFull = getColIndex(['เธขเธญเธ”เธฃเธงเธก', 'เน€เธฃเธตเธขเธ', 'เธเนเธฒเน€เธฃเธตเธขเธเธ—เธฑเนเธเธซเธกเธ”(เธเธฒเธ—)', 'เธเนเธฒเน€เธฃเธตเธขเธ(เธเธฒเธ—)', 'เธเนเธฒเน€เธฃเธตเธขเธ', 'เธขเธญเธ”เน€เธฃเธตเธขเธ', 'เธเนเธฒเน€เธฃเธตเธขเธเธ—เธฑเนเธเธซเธกเธ”', 'เธขเธญเธ”เธชเธธเธ—เธเธด', 'เธฃเธฒเธเธฒเธชเธธเธ—เธเธด']);
      const colOutstanding = getColIndex(['เธเธเน€เธซเธฅเธทเธญ', 'เธเนเธฒเธเธเธณเธฃเธฐเธ—เธฑเนเธเธซเธกเธ”(เธเธฒเธ—)', 'เธเนเธฒเธเธเธณเธฃเธฐ(เธเธฒเธ—)', 'เธเนเธฒเธเธเธณเธฃเธฐ', 'เธขเธญเธ”เธเธเน€เธซเธฅเธทเธญ', 'เธเธเน€เธซเธฅเธทเธญเธ—เธฑเนเธเธซเธกเธ”(เธเธฒเธ—)', 'เธเธเน€เธซเธฅเธทเธญเธ—เธฑเนเธเธซเธกเธ”', 'เธขเธญเธ”เธเนเธฒเธเธเธณเธฃเธฐ']);
      const colPaid = getColIndex(['เธขเธญเธ”เธเนเธฒเธขเธกเธฒ', 'เธขเธญเธ”เธเนเธฒเธข', 'เธเนเธฒเธขเธกเธฒ', 'เธเนเธฒเธข', 'เธขเธญเธ”เธเธณเธฃเธฐเธกเธฒ', 'เธเธณเธฃเธฐเธกเธฒ', 'เธขเธญเธ”เธเธณเธฃเธฐ', 'เธเธณเธฃเธฐเนเธฅเนเธง', 'เธเธณเธฃเธฐ', 'เธเธณเธฃเธฐเน€เธเธดเธ', 'เธขเธญเธ”เธเธณเธฃเธฐเน€เธเธดเธ', 'เธขเธญเธ”เธเนเธฒเธขเน€เธเธดเธ', 'เธขเธญเธ”เน€เธเธดเธเธเนเธฒเธข(เธเธฒเธ—)', 'เธขเธญเธ”เน€เธเธดเธเธเนเธฒเธข', 'เธเนเธฒเธขเน€เธเธดเธ', 'เธฃเธฑเธเธเธณเธฃเธฐ', 'เธฃเธฑเธเน€เธเธดเธ', 'เธขเธญเธ”เธฃเธฑเธเน€เธเธดเธ', 'เธขเธญเธ”เธฃเธฑเธเธเธณเธฃเธฐ', 'เธขเธญเธ”เน€เธเธดเธเธ—เธตเนเธเนเธฒเธข', 'เธเธณเธเธงเธเน€เธเธดเธเธ—เธตเนเธเนเธฒเธข', 'เน€เธเธดเธเธ—เธตเนเธเธณเธฃเธฐ']);
      const colDate = getColIndex(['เธงเธฑเธเธ—เธตเนเธเธณเธฃเธฐเน€เธเธดเธ', 'เธงเธฑเธเธ—เธตเนเธฃเธฑเธเน€เธเธดเธ', 'เธงเธฑเธเธ—เธตเนเนเธญเธ', 'เธงเธฑเธเธ—เธตเนเธเธณเธฃเธฐ', 'เธงเธฑเธเธ—เธตเน', 'เธงเธฑเธเธ—เธตเนเนเธญเธเน€เธเธดเธ', 'เธงเธฑเธเธ—เธตเนเธเนเธฒเธข', 'เธงเธฑเธเธ—เธตเนเนเธ”เนเธฃเธฑเธ']);
      const colChannel = getColIndex(['เธเนเธญเธเธ—เธฒเธเธเธณเธฃเธฐเน€เธเธดเธ', 'เธเนเธญเธเธ—เธฒเธเธเธฒเธฃเธฃเธฑเธเน€เธเธดเธ', 'เธเนเธญเธเธ—เธฒเธ', 'เธเนเธญเธเธ—เธฒเธเธเธฒเธฃเธเธณเธฃเธฐเน€เธเธดเธ', 'เธเนเธญเธเธ—เธฒเธเธเนเธฒเธข', 'เธงเธดเธเธตเธเธณเธฃเธฐ']);
      const colStaff = getColIndex(['เธเธนเนเธฃเธฑเธเน€เธเธดเธ', 'เธเธเธฑเธเธเธฒเธ', 'เธเธทเนเธญเธเธนเนเธฃเธฑเธเน€เธเธดเธ', 'เธเธนเนเธฃเธฑเธ']);
      const colCourse = getColIndex(['เธเธญเธฃเนเธช', 'เธเธญเธฃเนเธชเน€เธฃเธตเธขเธ', 'เธฃเธญเธเน€เธฃเธตเธขเธ']);
      const colNote = getColIndex(['เธซเธกเธฒเธขเน€เธซเธ•เธธ', 'เธซเธกเธฒเธขเน€เธซเธ•เธธเน€เธเธดเนเธกเน€เธ•เธดเธก']);
      const colBranchLearn = getColIndex(['เธชเธฒเธเธฒเน€เธฃเธตเธขเธ', 'เธชเธฒเธเธฒเน€เธฃเธตเธขเธ(เธชเธฒเธเธฒ)', 'เธชเธฒเธเธฒเธ—เธตเนเน€เธฃเธตเธขเธ']);
      const colBranchPay = getColIndex(['เธชเธฒเธเธฒเธ—เธตเนเน€เธเนเธเน€เธเธดเธ', 'เธชเธฒเธเธฒเน€เธเธดเธ(เธชเธฒเธเธฒ)', 'เธชเธฒเธเธฒเธ—เธตเนเธเนเธฒเธขเน€เธเธดเธ', 'เธชเธฒเธเธฒเน€เธเธดเธ']);
      const colName = getColIndex(['เธเธทเนเธญ-เธเธฒเธกเธชเธเธธเธฅ', 'เธเธทเนเธญ-เธชเธเธธเธฅ', 'เธเธทเนเธญ', 'เธเธทเนเธญเธเธฑเธเน€เธฃเธตเธขเธ']);
      const colNickname = getColIndex(['เธเธทเนเธญเน€เธฅเนเธ']);
      const colSchool = getColIndex(['เนเธฃเธเน€เธฃเธตเธขเธ']);
      const colContact = getColIndex(['เน€เธเธญเธฃเนเธ•เธดเธ”เธ•เนเธญ', 'เน€เธเธญเธฃเนเนเธ—เธฃ', 'เน€เธเธญเธฃเนเธเธนเนเธเธเธเธฃเธญเธ/เน€เธเธญเธฃเนเธ•เธดเธ”เธ•เนเธญ', 'เน€เธเธญเธฃเนเธเธนเนเธเธเธเธฃเธญเธ']);
      const colLineName = getColIndex(['เธเธทเนเธญเนเธเธฃเนเธเธฅเนเนเธฅเธเน', 'เธเธทเนเธญเนเธฅเธเน', 'profileline']);
      const colLineId = getColIndex(['idline', 'เนเธญเธ”เธตเนเธฅเธเน', 'lineid']);
      
      for (let j = 0; j < data.length; j++) {
        const safeVal = (idx) => (idx !== -1 && data[j] && data[j][idx] !== undefined) ? data[j][idx] : '';
        
        const cName = data[j][0] ? data[j][0].toString().trim() : ''; // Col B (เธเธทเนเธญ-เธชเธเธธเธฅ)
        ...
        if (!name || name === 'เธเธทเนเธญ-เธเธฒเธกเธชเธเธธเธฅ' || name.includes('เธเธทเนเธญ-เธชเธเธธเธฅ') || name === 'เธเธทเนเธญ') continue;
        ...
        if (isMainClass) {
           std.grade = grade;
           std.classType = 'เธเธฅเธธเนเธกเธซเธฅเธฑเธ';
           std.branchLearn = safeVal(colBranchLearn) || ('เธชเธฒเธเธฒ' + branchSuffix);
           std.branchPay = safeVal(colBranchPay) || ('เธชเธฒเธเธฒ' + branchSuffix);
           std.round = 'ManualSync';
        } else {
           // Private/Subgroup
           std.grade = sheetName.replace('เน€เธ”เธตเนเธขเธง ', '').replace('เธขเนเธญเธข ', '').replace('เธเธฅเธธเนเธก ', '').trim();
           std.classType = sheetName.split(' ')[0] === 'เน€เธ”เธตเนเธขเธง' ? 'เน€เธ”เนเธเน€เธ”เธตเนเธขเธง' : sheetName;
           std.branchLearn = safeVal(colBranchLearn) || 'เธชเธฒเธเธฒ1';
           std.branchPay = safeVal(colBranchPay) || 'เธชเธฒเธเธฒ1';
           std.round = safeVal(colCourse); // เธเธญเธฃเนเธช
           std.extraNote = safeVal(colNote); // เธซเธกเธฒเธขเน€เธซเธ•เธธ
        }
         ...
         if (res && res.type === 'append') {
             ...
             if (parseFloat(res.std.paid) > 0) {
                 paymentsToAdd.push({
                   ...
                   Channel: res.std.paymentChannel || 'เธเธณเธฃเธฐเนเธฃเธเน€เธเนเธฒ',
                   Receiver: res.std.staff || 'System',
                   Round: 'เนเธฃเธเน€เธเนเธฒ',
                   Note: res.std.paymentTimeNote || 'เธเธฒเธเธเธฒเธฃเธฅเธเธ—เธฐเน€เธเธตเธขเธเธเธฃเธฑเนเธเนเธฃเธ'
                 });
             }
